...
function AddProduct({ closeModal }) {
  ...
  return (
    <form onSubmit={handleAddProduct}>
      <div className='absolute mx-24 w-[750px] h-[600px] bg-aliceBlue left-0 top-28 rounded-[20px] flex flex-col justify-center'>
        <h1 className='text-center pt-3 text-blue Inter font-normal text-3xl'>Add Product</h1>
        <GrClose
          className='cursor-pointer text-3xl font-semibold absolute right-6 top-3'
